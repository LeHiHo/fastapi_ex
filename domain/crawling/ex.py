...
def run_selenium(keyword):
    ...
    try:
        ...
        aliExpress_url = f"https://ko.aliexpress.com/w/wholesale-{keyword}.html?spm=a2g0o.home.search.0"
        ...
        # aliExpress_products = crawl_site(driver, aliExpress_url, ['div', {'class': 'multi--title--G7dOCj3'}], ['h3'], ['div', {'class': 'multi--price-sale--U-S0jtj'}], ['span'])        
